...
| Auditoria recorrente da segurança Auth | workflow `Audit Supabase Auth security`; mínimo de 8 validado primeiro no staging | AUTOMATIZADO; HIBP DEPENDE DO PLANO PRO |
