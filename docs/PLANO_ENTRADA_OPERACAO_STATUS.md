...
| Auditoria recorrente da segurança Auth | workflow `Audit Supabase Auth security`; correção manual limitada ao staging | AUTOMATIZADO; HIBP DEPENDE DO PLANO PRO |
